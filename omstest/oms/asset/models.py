...
class HostList(models.Model):
    ip = models.CharField(max_length=200, verbose_name=u'IP地址')
...
class ServerAsset(models.Model):
    ...
    cpu_nums = models.PositiveIntegerField(verbose_name=u'cpu线程数')
    cpu_groups = models.PositiveIntegerField(verbose_name=u'cpu物理核数')
